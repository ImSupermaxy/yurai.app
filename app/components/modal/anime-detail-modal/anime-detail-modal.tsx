...
export default function AnimeDetailModal({ isVisible, changeStateModal, anime }: AnimeDetailModalModel & ModalDefaultModel) { 
  ...
  // setReviewsFiltred(reviews.filter(r => r.animeId == 1 && !r.isUserReview));
                ...
                <View style={styles.detalhes}>
                  ...
                  <View style={styles.rightSide}>
                    <View style={styles.rating}>
                      ...
                      <View style={{width: "100%", flexDirection: "row", gap: 4, alignItems: "center"}}>
                    ...
                    <View style={styles.bodyActions}>
                      ...
                      <View style={styles.action}>
                        <InteractiveIcon onPress={() => { console.log("adicionar ação de compartilhar...") }} icon={"share-variant-outline"} size={20} />
                          <Text style={{ fontSize: 8, color: colors.global.text }}>Compartilhar</Text>
                      </View>
                      <View style={styles.action}>
                        <InteractiveIcon onPress={changeFavorito} icon={isFavorito ? "heart" : "heart-outline"} size={20} />
